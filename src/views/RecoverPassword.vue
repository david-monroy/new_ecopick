        ...
        <v-col justify="center" align="center">
          ...
          <v-form ref="form">
            ...
            <v-row>
              ...
              <v-col>
                <v-btn rounded color="#a9ff4d" @click="searchRoute()" dark>{{
                  titleRecover
                }}</v-btn>
              </v-col>
          ...
          <v-row>
            <v-col> </v-col>
            <v-col>
              <a href="" @click="changePage('Login')" style="color: #454545;">{{
                loginLink
              }}</a>
            </v-col>
            <v-col>
...
export default class RecoverPassword extends Vue {
  ...
  description =
    "Fill in your email and we'll send you an email to reset your password";
  emailForm = "E-mail";
  goBack = "Go back";
